...
public class PlayerController2D : MonoBehaviour
{
    ...
    // Public variables
    public static float speed = 3f; // The speed at which the player moves
    ...
    void FixedUpdate()
    {
        ...
        Vector2 clampedPosition = new Vector2(
            Mathf.Clamp(transform.position.x, 0.2f, 99.8f), // Assuming screen width
            Mathf.Clamp(transform.position.y, 0.2f, 99.8f) // Assuming screen height
        );
